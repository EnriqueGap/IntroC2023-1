...
void rk2( float x, float y[], float step);
void rk3( float x, float y[], float step);
...
void rk2( float x, float y[], float step)
{
	int i;
	float h=0.5*step,	
		t1[N],				//Auxiliares para calcular k2
		k1[N], k2[N];			//Variables del Rk2
...
void rk3( float x, float y[], float step)
{
	int i;
	float h=0.5*step,	
		t1[N], t2[N],			//Auxiliares para calcular k2 y k3
		k1[N], k2[N], k3[N];		//Variables del Rk3
